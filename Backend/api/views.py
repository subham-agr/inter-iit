...
from api.functions import handle_uploaded_file
...
def posts(request):
    headers = {"Authorization": "Basic " + base64.b64encode(
        "MmuuRsRfMQaYJc2V8ABVq9CHcTvFC0GwCn7Mh5OZ:VijxQY2jXxzveKVhyfT0ZOiwIgcFxeUPLKhMSUzYLZZbjbTsr0xopWJVUKLlDSlvQFFH7M8wHVtd9xVq6XODHjOk4OA7y2iFc8DfLyDfq1yazIj4ds0G9YUTKSf3biX6".encode("utf-8")
    ).decode("utf-8"),
